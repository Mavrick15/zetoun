        ...
        <div className="absolute inset-0 bg-black w-full">
          <img
            ...
            onError={(e) => { // Fallback for image loading error
              ...
              e.currentTarget.src = "https://placehold.co/1200x750/333333/FFFFFF?text=Background+Image"; // Placeholder image
              e.currentTarget.alt = "Image de remplacement pour l'arrière-plan";
            }}
          />
          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              ...
              <motion.p className="banner-subtitle text-gray-300 mt-4 md:mt-6 text-sm md:text-base max-w-2xl mx-auto" variants={itemVariants}>
                ...
                et un support technique fiable pour particuliers et entreprises.
              </motion.p>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        delay: 0.6
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Formations personnalisées en technologies de l'information pour tous les niveaux, du débutant à l'expert.
            </p> {/* Description adaptée */}
          </motion.div>
