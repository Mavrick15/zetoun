...
const VirtualizationTraining = () => {
  ...
  return (
    <PageLayout>
      <SEO
        title="Formation Virtualisation : Concepts et Outils (VirtualBox, VMware, KVM)"
        description="Maîtrisez la virtualisation avec notre formation : hyperviseurs, création et gestion de VMs, réseaux virtuels et conteneurs (Docker)."
      />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <div className="p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600">Des professionnels certifiés disposant d’une expérience pratique dans le déploiement et la gestion d’environnements virtual
isés.</p>
              </div>
              <div className="p-6 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-lg mb-2">Approche pratique</h3>
                <p className="text-gray-600">Nos formations en virtualisation combinent théorie et pratique sur des environnements virtualisés modernes, couvrant le dép
loiement, la gestion et l’optimisation.</p>
              </div>
              <div className="p-6 bg-gray-50 rounded-lg">
