...
const WindowsAdministration = () => {
  ...
  return (
    <PageLayout>
      <SEO
        title="Formation Administration Système Windows Server | AD, GPO"
        description="Devenez administrateur Windows Server : installation, configuration, gestion des rôles (AD, DNS, DHCP, GPO) et sécurité."
      />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <div className="p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600">Des professionnels certifiés avec une expérience pratique dans la gestion, la sécurisation et le dépannage des environnemen
ts Windows Server et postes clients.</p>
              </div>
              <div className="p-6 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-lg mb-2">Approche pratique</h3>
                <p className="text-gray-600">Nos formations en administration Windows combinent théorie et travaux pratiques sur des environnements Windows Server réels
, incluant la gestion des utilisateurs, des services réseau et des stratégies de groupe.</p>
              </div>
              <div className="p-6 bg-gray-50 rounded-lg">
