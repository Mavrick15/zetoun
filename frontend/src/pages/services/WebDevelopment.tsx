    ...
    <div className="min-h-screen bg-white">
      <PageLayout>
        ...
        <SEO
          ...
          description="Zetoun Labs conçoit des sites web professionnels à Kinshasa : sites vitrines, e-commerce, design responsive, optimisation SEO et maintenance continue pour votre activité."
          keywords={[
            'conception web',
        ...
        <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="max-w-6xl mx-auto">
              ...
              >
                Zetoun Labs conçoit des solutions web sur mesure pour votre activité à Kinshasa, créant des plateformes performantes et adaptées à vos objectifs de croissance numérique.
              </motion.p>
                  ...
                  <ul className="space-y-4 text-lg">
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Design élégant reflétant l'image de votre entreprise et ses valeurs, optimisé pour l'impact.</p>
                      </div>
                    </li>
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      <span className="text-green-500 font-bold mr-3 text-xl">•</span>
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Boutiques en ligne performantes avec gestion des stocks, systèmes de paiement sécurisés et expérience client fluide.</p>
                      </div>
                    </li>
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      <span className="text-green-500 font-bold mr-3 text-xl">•</span>
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Expérience utilisateur optimale et affichage parfait sur tous les appareils : ordinateurs, tablettes et smartphones.</p>
                      </div>
                    </li>
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      <span className="text-green-500 font-bold mr-3 text-xl">•</span>
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Référencement naturel efficace pour une meilleure visibilité sur Google et des temps de chargement ultra-rapides.</p>
                      </div>
                    </li>
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      <span className="text-green-500 font-bold mr-3 text-xl">•</span>
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Administration facile de votre contenu via des interfaces intuitives pour une autonomie totale.</p>
                      </div>
                    </li>
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      <span className="text-green-500 font-bold mr-3 text-xl">•</span>
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Assistance technique réactive et évolution permanente de votre site. Découvrez aussi notre service de <Link to="/services/technical-support" className="text-green-600 hover:underline font-semibold">support technique informatique</Link>.</p> {/* Lien interne ajouté */}
                      </div>
                    </li>
                  </ul>
                </motion.div>
                ...
                >
                  <div className="bg-green-50 p-8 rounded-xl border border-green-100 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-700 mb-4">
                      La création d'un site web efficace passe par une compréhension approfondie de votre activité, de vos objectifs et de votre public cible. Chez Zetoun Labs, nous travaillons en étroite collaboration avec vous à Kinshasa pour concevoir une solution web qui reflète votre identité et répond précisément à vos attentes.
                    </p>
                    <p className="text-gray-700">
                      Notre approche privilégie la simplicité d'utilisation, un design moderne et les performances techniques pour garantir une expérience utilisateur optimale et un référencement solide.
                    </p>
                  </div>
              ...
              >
                ...
                <div className="bg-green-500 text-white p-6 rounded-lg hover:bg-green-600 transition-colors">
                  <p className="font-medium">
                    Contactez-nous pour discuter de votre projet de conception web et obtenir un devis personnalisé pour une solution sur mesure à Kinshasa.
                  </p>
                </div>
              </motion.div>
            </div>
