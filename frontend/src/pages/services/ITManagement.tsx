            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-700 mb-6">
                  Nos formules d'infogérance s'adaptent à vos besoins spécifiques, qu'il s'agisse d'une supervision
                  ponctuelle ou d'une prise en charge complète de votre système d'information. Chez Zetoun Labs,
                  nous élaborons avec vous un contrat de service (SLA) précis, détaillant les niveaux de disponibilité
                  garantis et les temps de réponse en cas d'incident pour une tranquillité d'esprit totale.
                </p>

                <div className="bg-purple-500 text-white p-6 rounded-lg hover:bg-purple-600 transition-colors">
                  <p className="font-medium">
                    Contactez-nous dès aujourd'hui pour une évaluation gratuite de vos besoins en infogérance et
                    découvrez comment nos services peuvent sécuriser et optimiser durablement votre infrastructure
                    IT à Kinshasa.
                  </p>
                </div>
              </motion.div>
