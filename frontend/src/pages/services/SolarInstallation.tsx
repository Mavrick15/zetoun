    ...
    <div className="min-h-screen bg-white font-inter">
      <PageLayout>
        ...
        <SEO
          ...
          description="Profitez de l'énergie propre à Kinshasa avec Zetoun Labs : conception, installation et maintenance de systèmes solaires photovoltaïques résidentiels et commerciaux."
          keywords={[
        ...
        <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="max-w-6xl mx-auto">
              ...
              >
                Zetoun Labs est votre partenaire de confiance à Kinshasa pour la conception et l'installation de systèmes solaires photovoltaïques, vous permettant de bénéficier d'une énergie propre, fiable et économique.
              </motion.p>
                  ...
                  <ul className="space-y-4 text-lg">
                    ...
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Analyse de votre consommation et des contraintes spécifiques de votre site à Kinshasa.</p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Intégration optimale des panneaux, onduleurs et systèmes de stockage pour une efficacité maximale.</p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Réalisée par des techniciens certifiés, respectant les normes de sécurité et de qualité internationales.</p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Pour une autonomie accrue et une disponibilité d'énergie constante, même en l'absence de soleil.</p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Assurant la performance et la longévité de votre installation solaire.</p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">Pour une gestion optimisée de votre consommation et de votre production d'énergie.</p>
                      </div>
                    </li>
                  </ul>
                </motion.div>
                ...
                >
                  <div className="bg-yellow-50 p-8 rounded-xl border border-yellow-100 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-700 mb-4">
                      Chaque projet solaire est unique. Notre équipe d'experts à Kinshasa s'engage à vous fournir une solution énergétique personnalisée, qui maximise votre production d'énergie, réduit vos coûts et contribue à un avenir plus durable.
                    </p>
                    <p className="text-gray-700">
                      Nous sélectionnons des équipements de haute qualité et appliquons des techniques d'installation rigoureuses pour garantir la fiabilité et la performance à long terme de votre système solaire.
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-600 text-sm">Réduisez significativement vos factures d'électricité et gagnez en indépendance énergétique à Kinshasa.</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-600 text-sm">Des systèmes conçus pour durer, offrant une source d'énergie stable et performante sur le long terme.</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-600 text-sm">Contribuez à la réduction des émissions de carbone et à la protection de l'environnement.</p>
                  </div>
                </motion.div>
              </div>
              ...
              >
                ...
                <p className="text-gray-700 mb-6">
                  Que vous soyez un particulier souhaitant réduire sa facture d'électricité ou une entreprise visant l'autonomie énergétique, Zetoun Labs est votre partenaire idéal à Kinshasa. Nous vous accompagnons à chaque étape de votre projet solaire, de l'étude à la mise en service.
                </p>
